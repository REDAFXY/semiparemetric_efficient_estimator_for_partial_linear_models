...
def writemse(ntimes,errortype,betaresultall):
    betalse,betalsekdre,betalekdre = betaresultall[-1],betaresultall[-2],betaresultall[-3]
    p=3
...
def writemad(ntimes,errortype,betaresultall):
    betalse,betalsekdre,betalekdre = betaresultall[-1],betaresultall[-2],betaresultall[-3]
    p=3
    beta=np.array([3,1.5,2])
    mse_es0=[]
...
def KDRESIM(ntimes,errortype,betaresultall):
    #lsekdre
    p = 3
    aaa,bbb,ccc,betakdre = betaresultall[-4],betaresultall[-5],betaresultall[1],betaresultall[-2]
    sd_es=[]
    sd_es2=[]
    sd_es3=[]
    mean_es=[]
...
def KDRESIM2(ntimes,errortype,betaresultall):
    #kdre
    p = 3
    aaa,bbb,ccc,betakdre = betaresultall[-4],betaresultall[-5],betaresultall[1],betaresultall[-3]
    sd_es=[]
    sd_es2=[]
    sd_es3=[]
    mean_es=[]
